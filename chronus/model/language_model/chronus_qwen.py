...
from ..chronus_arch import ChronusMetaModel, ChronusMetaForCausalLM
from transformers import Qwen2Config, Qwen2Model, Qwen2ForCausalLM


class ChronusConfigQwen(Qwen2Config):
    model_type = "chronus_qwen"


class ChronusQwenModel(ChronusMetaModel, Qwen2Model):
    config_class = ChronusConfigQwen

    def __init__(self, config: Qwen2Config):
        super(ChronusQwenModel, self).__init__(config)


class ChronusQwenForCausalLM(Qwen2ForCausalLM, ChronusMetaForCausalLM):
    config_class = ChronusConfigQwen
    ...
    def __init__(self, config):
        ...
        self.model = ChronusQwenModel(config)
...
AutoConfig.register("chronus_qwen", ChronusConfigQwen)
AutoModelForCausalLM.register(ChronusConfigQwen, ChronusQwenForCausalLM)
